    ...
    public static String declareWinner(Fighter fighter1, Fighter fighter2, String firstAttacker) {
            ...
            while (true) {
                if (firstAttacker.equals(fighter1.name)) {
                    ...
                    System.out.println(fighter2.name + " получил " + fighter1.damagePerAttack + " урона " + " и у него" +
                    ...
                    System.out.println(fighter1.name + " получил " + fighter2.damagePerAttack + " урона " + " и у него" +
